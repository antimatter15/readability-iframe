if(location.hash.indexOf('read') != -1){
  ...
  if(searchmap.readStyle && searchmap.readSize && searchmap.readMargin){
    location.hash = '#'
    var baseHref = "http://lab.arc90.com/experiments/readability/";
    ...
    script.innerText = linkStringStart + "readStyle='" + searchmap.readStyle + "';readSize='" + searchmap.readSize + "';readMargin='" + searchmap.readMargin + linkStringEnd;
